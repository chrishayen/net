...
CONST PROTOCOL_NAME = "Noise_IKpsk2_25519_ChaChaPoly_BLAKE2s" 
CONST EMPTY_HASH = BLAKE2s("") # Empty hash as starting point 
CONST INITIAL_CHAINING_KEY = BLAKE2s(PROTOCOL_NAME) # Initial chaining key 
hash = EMPTY_HASH 
